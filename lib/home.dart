...
Future<void> preloadImages(BuildContext context,
...
class _HomeState extends State<Home> {
  ...
  List<Item> data = [
    Item(name: 'Badminton',
        imgUrl: 'assets/images/badminton.jpg',
        description: 'In Good Working Conditions',
        rentStatus: true,
        saleStatus: false,
        price: 400.0)
  ];
                  ...
                  Expanded(
                    child: ListView.builder(
                      ...
                      itemBuilder: (context, index) {
                        String rentMsg = data[index].rentStatus
                            ? 'On Rent'
                            : 'Not On Rent';
                        String saleMsg = data[index].saleStatus
                            ? 'On Sale'
                            : 'Not On Sale';
